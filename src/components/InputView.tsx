...
・例文がない場合は、単語レベルに合わせた例文を生成して`;
    ...
    return (
        <div className="space-y-4">
            ...
            {mode === "single" ? (
                /* ── 1件ずつモード（既存） ── */
                <form onSubmit={handleSubmit} className="space-y-3 md:space-y-2.5 pb-6">
                    {/* 単語 */}
                    <div>
                ...
                /* ── 一括登録モード ── */
                <div className="space-y-4 md:space-y-5 pb-6 has-[.group:focus-within_details[open]]:pb-56 has-[.group:hover_details[open]]:pb-56">
                    {/* 区切り文字 */}
                    <div>
