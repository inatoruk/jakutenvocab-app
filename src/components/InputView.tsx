...
・例文がない場合は、単語レベルに合わせた例文を生成して`;
    ...
    const aiContent = (
        <>
            ...
            <p>あとは、AIが出力してくれたテキストをそのままコピーしてここに貼り付けるだけで、一気に登録ができます。</p>
        </>
    );
        ...
        <div className={mode === "single" ? "space-y-4 md:space-y-3" : "space-y-4"}>
            ...
            <div className="flex rounded-lg border border-gray-200 bg-gray-50 p-0.5 relative z-20">
                ...
                <div
                    ...
                    className={`relative flex-1 rounded-md px-3 py-2 text-sm font-medium transition-colors cursor-pointer outline-none ${mode === "bulk"
                        ? "text-gray-800"
                        : "text-gray-500 hover:text-gray-700"
                        }`}
                    style={{ WebkitTapHighlightColor: "transparent" }}
                >
                    ...
                    <div className="relative z-10 flex h-full w-full items-center justify-center gap-1.5" style={{ transform: "translateZ(0)" }}>
                        ...
                        <div 
                            className="absolute w-[calc(200%+52px)] right-[-14px] sm:right-auto sm:left-[-12px] sm:-translate-x-1/2 sm:w-[400px] top-[35px] transition-all duration-300 py-3 px-4 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-xs rounded-xl border border-gray-200 dark:border-gray-700/80 shadow-xl z-50 leading-normal text-left origin-top-right md:w-[550px] md:after:content-[''] md:after:absolute md:after:-top-8 md:after:left-0 md:after:w-full md:after:h-8 opacity-0 invisible pointer-events-none scale-95 group-hover:opacity-100 group-hover:visible group-hover:pointer-events-auto group-hover:scale-100 group-focus-within:opacity-100 group-focus-within:visible group-focus-within:pointer-events-auto group-focus-within:scale-100 cursor-default"
                        ...
                        >
                            ...
                            <p className="mb-2 text-gray-600 dark:text-gray-100">
                                ※ 例文は省略しても大丈夫です。<br />
            ...
            {mode === "single" ? (
                        ...
                        <div className="flex items-center gap-3 mb-1">
                            <div className="flex items-center gap-1.5">
                                ...
                                >
                                    ...
                                    <div 
                                        className="absolute left-full ml-3 top-1/2 -translate-y-[90px] md:-translate-y-[30%] w-[310px] md:w-[580px] transition-all duration-300 p-3 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-xs rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg z-50 leading-normal text-left origin-left md:after:content-[''] md:after:absolute md:after:right-full md:after:top-0 md:after:w-4 md:after:h-full opacity-0 invisible pointer-events-none transform-gpu antialiased scale-95 group-hover:opacity-100 group-hover:visible group-hover:pointer-events-auto group-hover:scale-100 group-focus-within:opacity-100 group-focus-within:visible group-focus-within:pointer-events-auto group-focus-within:scale-100"
                                    >
                ...
                /* ── 一括登録モード ── */
                <div className="space-y-4 md:space-y-5 has-[.group:focus-within_details[open]]:pb-56 has-[.group:hover_details[open]]:pb-56">
                    {/* 区切り文字 */}
                    <div>
