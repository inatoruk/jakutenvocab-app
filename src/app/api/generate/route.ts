    ...
    try {
        ...
        if (type === 'meaning') {
            ...
            const situations = [
                '社内メールでの業務連絡・進捗共有',
                '同僚とのミーティングや業務調整の会話',
                '顧客からの問い合わせやクレームへの返答メール',
                '取引先への提案や契約交渉のビジネスレター',
                '新商品の発売やサービス変更のプレスリリース・告知',
                '社内研修やイベントの案内アナウンス',
                'オフィスのITトラブルや機器不良の問い合わせ',
                'ホテルでのチェックインやレストランでの予約・注文',
                '空港や駅での出発遅延や乗り継ぎの案内アナウンス',
                '病院やクリニックでの予約受付や症状の説明',
                '買い物での返品・返金や発送遅延に関するカスタマーサポートとのやり取り',
                '採用面接での自己紹介や職務経歴の説明'
            ];
